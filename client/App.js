...
import { requestUserPermission, notificationListener, getToken} from './apis/firebaseMessage'
...
function App({ navigation, route, isSnsLogin, setIsSnsLogin }) {
  ...
  useEffect(() => {
    ...
    const handleNotificationOpen = async (remoteMessage) => {
      console.log('Notification opened:', remoteMessage.notification);
      if (remoteMessage.data.type) {
      
      }
    }  
    const unsubscribeOnNotificationOpen = messaging().onNotificationOpenedApp(handleNotificationOpen);
